...
class TestFormatPicker:
    ...
    def test_success(self):
        ...
        ph
        """
        assert self.sheet2.format_picker("Name") == ["default_border"]
        assert self.sheet2.format_picker("Percent") == ["default_border", "percent"]
        assert self.sheet2.format_picker("Price") == ["default_border", "currency"]
        assert self.sheet2.format_picker("Hours") == ["default_border", "decimal"]
        assert self.sheet2.format_picker("ID") == ["default_border", "integer"]
